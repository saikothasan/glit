/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: c314439a2a6b7f2df33d140ac5edad14)
// Runtime types generated with workerd@1.20260107.1 2024-10-22 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "ResearchWorkflow" | "Sandbox" | "PolymathAgent";
	}
	interface Env {
		PRIMARY_AGENT: DurableObjectNamespace<import("./worker/index").PolymathAgent>;
		CODE_SANDBOX: DurableObjectNamespace /* Sandbox */;
